...
function Oval(props) {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "g",
      __assign({ transform: "translate(1 1)", fill: "none", fillRule: "evenodd" }, { stroke, strokeWidth, strokeOpacity }),
      import_react.default.createElement("circle", { strokeOpacity: 0.5, cx: 18, cy: 18, r: 18 }),
      import_react.default.createElement(
        "path",
        { d: "M36 18c0-9.94-8.06-18-18-18" },
        import_react.default.createElement("animateTransform", { attributeName: "transform", type: "rotate", from: "0 18 18", to: "360 18 18", dur: "".concat(1 / speed, "s"), repeatCount: "indefinite" })
      )
    )
  );
}
...
//# sourceMappingURL=chunk-TTVWPO42.js.map
